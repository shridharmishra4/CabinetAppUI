...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        self.left_int = QCheckBox(get_str('LeftInteraction'))
        self.left_int.setChecked(False)
        self.left_int.stateChanged.connect(self.button_state)

        self.right_int = QCheckBox(get_str('RightInteraction'))
        self.right_int.setChecked(False)
        self.right_int.stateChanged.connect(self.button_state)
        ...
        list_layout.addWidget(self.left_int)
        list_layout.addWidget(self.right_int)
        ...
        self.left_interaction = False
        self.right_interaction = False
        ...
        Shape.left_interaction = self.left_interaction
        Shape.right_interaction = self.right_interaction
    ...
    def button_state(self, item=None):
        ...
        left_interaction = self.left_int.isChecked()
        right_interaction = self.right_int.isChecked()
        ...
        # Checked and Update
        try:
            if left_interaction != shape.left_interaction:
                shape.left_interaction = left_interaction
                self.set_dirty()
            else:  # User probably changed item visibility
                self.canvas.set_shape_visible(shape, item.checkState() == Qt.Checked)
            
            if right_interaction != shape.right_interaction:
                shape.right_interaction = right_interaction
                self.set_dirty()
            else:  # User probably changed item visibility
                self.canvas.set_shape_visible(shape, item.checkState() == Qt.Checked)
    ...
    def load_labels(self, shapes):
        s = []
        for label, points, line_color, fill_color, difficult,left_interaction,right_interaction in shapes:
    ...
    def save_labels(self, annotation_file_path):
        ...
        def format_shape(s):
            return dict(label=s.label,
                        ...
                        right_interaction = s.right_interaction,
                        left_interaction = s.left_interaction)
    ...
    def label_selection_changed(self):
        ...
        if item and self.canvas.editing():
            ...
            self.left_int.setChecked(shape.left_interaction)
            self.right_int.setChecked(shape.right_interaction)
